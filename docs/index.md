...
These notes are work in progress, still far from completion.

## Table of contents

+ [What is Condensed Matter Physics?](introduction.md)
+ [Mathematical Physics](category/mathematical-physics)
    - [Fourier Transform](mathematical-physics/fourier-transform.md)
...
+ [Crystal structure](category/crystal-structure)
...
+ [Crystal growth](category/crystal-growth)
...
+ [Characterization](category/characterization)
...
+ [Electronic structure](category/electronic-structure)
    ...
    - [Hubbard Model](electronic-structure/hubbard-model.md)
+ [Angle Resolved Photoemission Spectroscopy](category/arpes)
    - [ARPES Introduction](arpes/arpes-intro.md)
